...
""",
    ...
    if my_test == 1:
        args.train_file = WindowsPath("C:\\Users\\99721\\OneDrive - Johns Hopkins University\\Fall 2019 course\\NLP\\Homework3\\hw-lm\\gen_spam\\train\\spam")
...
def main():
    ...
    if args.mode == TRAIN:
        ...
        lm.set_vocab_size(args.train_file)
        ...
        for test_file in args.test_files:
            ...
            print(f"{log_prob:g}\t{test_file.name}")
